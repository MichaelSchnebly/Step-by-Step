...
The ideal human-computer interface can adapt to a user's needs or preferences. It can be used by anyone, regardless of their physical abilities. It can be used in any context, regardless of the user's surroundings. It can be used to control any device, regardless of its form factor. It can be used to control any application, regardless of its purpose.
