...
\begin{abstract}
Recognizing user-defined gestures in IMU data unlocks new forms of creativity and accessibility in human-computer interaction. However, training gesture recognition models is a difficult task that requires a deep understanding of machine learning. We present Step-by-Step, a software tool that allows users to train gesture recognition models with live visual and auditory feedback. Step-by-Step is designed to be accessible to users with no machine learning experience, while providing a powerful codebase for advanced users. This work makes the following contributions: ...
% (1) a novel interface for training gesture recognition models with live feedback, (2) a novel interface for visualizing IMU data, and (3) a novel interface for visualizing gesture recognition models.
\end{abstract}
]
